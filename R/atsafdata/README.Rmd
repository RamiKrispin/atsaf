...
Currently the package is not available on CRAN, and you can be install the development version of atsafdata from [GitHub](https://github.com/RamiKrispin/atsaf/tree/atsafdata/R/atsafdata):
